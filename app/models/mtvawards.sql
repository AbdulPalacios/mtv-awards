...
-- Tiempo de generación: 08-12-2025 a las 21:34:46
...
CREATE TABLE IF NOT EXISTS `albumes` (
  ...
  `titulo_album` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_album` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `imagen_album` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(26, 0, '2021-01-10', 'Ah y Qué?', 'Los inicios.', 'recursos/assets/uploads/album/ahyque.jpg', 8, 13),
...
(44, 1, '2002-12-12', 'bkjhvkh', 'kuy78970987098ph', 'recursos/assets/uploads/album/1765219479_MECX.jpg', 18, 24);
...
CREATE TABLE IF NOT EXISTS `artistas` (
  ...
  `pseudonimo_artista` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nacionalidad_artista` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `biografia_artista` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `id_usuario` int NOT NULL,
  `id_genero` int DEFAULT NULL,
  `imagen_artista` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(13, 1, 'Taylor Swift', 'Estadounidense', 'La industria musical.', 34, 1, NULL),
(14, 1, 'Karol G', 'Colombiana', 'La Bichota.', 35, 5, NULL),
(15, 0, 'Feid', 'Colombiana', 'El Ferxxo mor.', 36, 5, NULL),
(16, 1, 'Dua Lipa', 'Británica', 'Reina del Nu-Disco.', 37, 1, NULL),
(17, 1, 'Kendrick Lamar', 'Estadounidense', 'Rapero legendario.', 38, 3, NULL),
(18, 1, 'calimba', 'peruana', 'kujsbhdlsiujna', 45, 24, 'recursos/assets/uploads/artistas/1765219055_MECX.jpg');
...
CREATE TABLE IF NOT EXISTS `canciones` (
  ...
  `nombre_cancion` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `fecha_lanzamiento_cancion` date NOT NULL,
  `duracion_cancion` time DEFAULT NULL,
  `mp3_cancion` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_cancion` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_video_cancion` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_album` int DEFAULT NULL,
  `id_artista` int NOT NULL,
  `id_genero` int NOT NULL,
  `imagen_cancion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `categorias_nominaciones` (
  ...
  `nombre_categoria_nominacion` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `generos` (
  ...
  `nombre_genero` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `multimedia_canciones` (
  ...
  `estatus_album` tinyint NOT NULL,
  `formato_mp3` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_streaming` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_video_clip` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(14, '2025-12-07 02:46:41', 3, NULL, NULL, 171, 9),
(15, '2025-12-07 02:46:41', 4, 1, NULL, 300, NULL),
(16, '2025-12-07 02:46:41', 4, 11, NULL, 251, NULL),
(17, '2025-12-07 02:46:41', 4, 8, NULL, 200, NULL),
(18, '2025-12-07 02:46:42', 5, NULL, NULL, 91, 1),
(19, '2025-12-07 02:46:42', 5, NULL, NULL, 85, 6),
(20, '2025-12-07 02:46:42', 5, NULL, NULL, 120, 8),
(21, '2025-12-08 18:47:34', 4, 18, NULL, 1, NULL),
(22, '2025-12-08 18:48:33', 3, NULL, NULL, 0, 5);
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `ap_usuario` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `am_usuario` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sexo_usuario` tinyint DEFAULT NULL,
  `correo_usuario` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `password_usuario` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `imagen_usuario` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_rol` int NOT NULL,
...
(2, 1, 'Manager', 'Latino', NULL, NULL, 'manager_latino@mtv.com', '$2y$10$4Ui3K6Iyv/Z.g1/xW6dQXeIoYCb6jqCsP9jnUgilxsbr3qXCOtLPW', NULL, 2),
(3, 1, 'Manager', 'USA', NULL, NULL, 'manager_usa@mtv.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 2),
(10, 1, 'Faraon', 'Shady', NULL, NULL, 'faraon@mtv.com', '$2y$10$4Ui3K6Iyv/Z.g1/xW6dQXeIoYCb6jqCsP9jnUgilxsbr3qXCOtLPW', NULL, 3),
...
(34, 1, 'Jesus', 'Cuapio', 'Mendoza', 1, 'cuapiomendoza5@hotmail.com', '$2y$12$fMR1UIdMwNxJNRsHHUqL8uq.4IgP7SC8Rnd4MqKdrbe0/WKum6nri', NULL, 4),
(35, 1, 'Taylor', 'Swift', NULL, 2, 'taylor@mtv.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 3),
(36, 1, 'Karol', 'G', NULL, 2, 'karolg@mtv.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 3),
(37, 1, 'Feid', 'Ferxxo', NULL, 1, 'feid@mtv.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 3),
(38, 1, 'Dua', 'Lipa', NULL, 2, 'dua@mtv.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 3),
(39, 1, 'Kendrick', 'Lamar', NULL, 1, 'kendrick@mtv.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 3),
(40, 1, 'Juan', 'Perez', 'Diaz', 1, 'juanp@gmail.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 4),
(41, 1, 'Maria', 'Lopez', 'Rios', 2, 'marial@gmail.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 4),
(42, 1, 'Carlos', 'Vega', 'Soto', 1, 'carlosv@gmail.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 4),
(43, 1, 'Luisa', 'Mendez', 'Ruiz', 2, 'luisam@gmail.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 4),
(44, 1, 'Pedro', 'Gomez', 'Cruz', 1, 'pedrog@gmail.com', '$2y$10$Xw6Lx.Fj.x7.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x', NULL, 4),
(45, 1, 'calimba', 'siiii', 'ci', 1, 'calimba1818@mtv.com', '$2y$10$pSAitdYNEqvj.BMNWZTS.eB43jMg0F0ScrrWDfbnQACp4D5k9SbUu', 'recursos/assets/uploads/usuarios/1765218954_MECX.jpg', 3);
...
INSERT INTO `votaciones` (`id_votacion`, `fecha_votacion`, `id_nominacion`, `id_usuario`) VALUES
(1, '2025-12-08 18:03:07', 18, 33),
(2, '2025-12-08 18:03:27', 16, 33),
(3, '2025-12-08 18:03:34', 14, 33),
(4, '2025-12-08 18:49:09', 21, 31);
